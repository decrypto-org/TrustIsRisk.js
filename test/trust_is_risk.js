...
const fakePubKeyArray = [0x04, 0x54, 0x72, 0x75, 0x73, 0x74, 0x20, 0x69, 0x73,
  0x20, 0x52, 0x69, 0x73, 0x6b, 0x00, 0x00, 0x00, 0x00,
...
describe("TrustIsRisk", () => {
  ...
  describe("tag", () => {
    ...
    it("corresponds to a public key that contains \"Trust is Risk\"", () => {
      const fakePubKeyArray = [0x04, 0x54, 0x72, 0x75, 0x73, 0x74, 0x20, 0x69, 0x73,
      bcoin.httpWallet.getKey(Address.fromString(tag.toString("ascii"))).should.equal(fakePubKeyArray);
        0x20, 0x52, 0x69, 0x73, 0x6b, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
